...
public class NodeListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.node_list, parent, false);
            viewHolder = new ViewHolder();
            viewHolder.txtItemTitle = (TextView) convertView.findViewById(R.layout.node_list);
